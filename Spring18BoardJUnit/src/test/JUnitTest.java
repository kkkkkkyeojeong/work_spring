...
public class JUnitTest {
	...
	public void setUp() {
		...
		// 사용자 기본 정보 생성
		this.users1 = new Users(null, "users1@koitt.com", password, "영미", null);
		this.users2 = new Users(null, "users2@koitt.com", password, "은정", null);
		this.users3 = new Users(null, "users3@koitt.com", password, "금정", null);
		...
		/*
		 *  2. 1번에서 생성한 권한 객체를 Set 컬렉션에 넣는다
		 *  adminSet - 관리자 권한만 부여
		 *  userSet - 사용자 권한만 부여
		 *  bothSet - 관리자, 사용자 권한 부여
		 */
		adminSet.add(admin);
		...
		// 게시글
		this.board1 = new Board(null, "제목1", "내용1", null, null, null);
	...
	// 게시글 추가, 가져오기 테스트 
	@Test 
	public void addAndGetBoard() throws UsersException, BoardException {
		// 1. 독립적인 단위 테스트를 위해 테이블 삭제 -> board, users_authority, users 순으로 삭제 
		boardDao.deleteAll();
		assertThat(boardDao.getCount(), is(0));
		...
		Integer userNo = usersDao.selectLastInsertId();		// 추가한 사용자 번호 가져오기 
